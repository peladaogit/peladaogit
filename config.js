/*
* Construído por markos w. - para o grupo chat dos heteros
...
module.exports = kconfig = async (kill, message) => {
    ...
    try {
		...
		case 'heteros':
			...
			await kill.sendLinkWithAutoPreview(from, 'https://chat.whatsapp.com/I4EFsvnJEC219kJbaD8KuS', 'Que otimo que se interessou pelo chat dos heteros!\nAi está nosso grupo!', id)
			break
       ...
       case 'clima':
        ...
        case 'menu':
            ...
            kill.reply(from, `Grupo oficial da iris:\n\n━━━━━━━━⊱⸸⊰━━━━━━━━\n\n-❯➣ GRUPO DE CHAT.\n\n-❯➣ BOT FUNCIONANDO 24H.\n\nhttps://chat.whatsapp.com/I4EFsvnJEC219kJbaD8KuS\n\n━━━━━━━━⊱⸸⊰━━━━━━━━`, id)
            break
